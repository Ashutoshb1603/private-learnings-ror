module BxBlockLocation
  class VansController < ApplicationController
    ...
    #   render json: {
    #     errors: {message: 'No van\'s present near your location'}
    ...
    #   render json: {
    #     errors: {message: 'Please select service provider'}
    ...
    #   render json: { errors: {message: 'Something goes wrong, location is not updated'} }
    # end
    ...
    # def lat_lon
    #   render json: {
    #     errors: {message: 'Please send location'}
    ...
    #   )
    #   return {errors: {message: 'Something went wrong'}} unless distance.present?
