...
RSpec.describe BxBlockCatalogue::TagsController, type: :controller do
  describe 'POST create' do
    before do
      ...
      @tag = create(:tag)
      @catalogue = create(:catalogue , category: @category , sub_category: @sub_category)
    ...
    context "when we create catalogues variants size with correct params" do
      it 'Returns created' do
        post :create, params: { token: @token, title: "titile" }
