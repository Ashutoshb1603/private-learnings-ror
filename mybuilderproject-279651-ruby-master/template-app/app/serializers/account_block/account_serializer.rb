module AccountBlock
  class AccountSerializer < BuilderBase::BaseSerializer
    attributes(:user_type, :activated, :country_code, :email, :operator_name, :full_phone_number, :contact_name, :phone_number, :operator_address, :type, :created_at, :updated_at, :device_id, :unique_auth_id)
