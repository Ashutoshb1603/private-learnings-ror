...
RSpec.describe Admin::BusinessJetOperatorsController, type: :controller do
  render_views
  before(:each) do
  ...
  describe "Get#index" do
    ...
    it "show all data" do
      stub_request(:get, "https://api.radarbox.com/v2/statistics/flights/business/operators").
         with(
           headers: {
          'Accept'=>'*/*',
